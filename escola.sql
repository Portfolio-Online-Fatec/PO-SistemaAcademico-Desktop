...
CREATE TABLE IF NOT EXISTS `boletins` (
  ...
  `disciplinaID` int NOT NULL,
  `usuarioID` int NOT NULL,
  PRIMARY KEY (`boletimID`,`disciplinaID`),
...
CREATE TABLE IF NOT EXISTS `chamadas` (
  ...
  `faltasAluno` tinyint(1) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  KEY `fk_USUARIOS_enderecoUsuarios1_idx` (`enderecoUsuarioID`),
  CONSTRAINT `fk_USUARIOS_enderecoUsuarios1` FOREIGN KEY (`enderecoUsuarioID`) REFERENCES `enderecousuarios` (`enderecoUsuarioID`),
